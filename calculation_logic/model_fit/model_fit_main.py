...
# Assume 'yield_curve_data' and 'market_maturities' are available
# from the previous section's execution context.
# For standalone execution, you might need to load/recreate them here.

# Example placeholder if running this section independently:
...
# --- Section 3: Implementing and Calibrating the Nelson-Siegel Model ---
...
if optimization_result.success:
    ...
    # Handle failure case - perhaps use initial guesses or stop
    optimized_params_ns = initial_guesses # Fallback to initial guesses for plotting
    beta0_opt, beta1_opt, beta2_opt, tau1_opt = optimized_params_ns
